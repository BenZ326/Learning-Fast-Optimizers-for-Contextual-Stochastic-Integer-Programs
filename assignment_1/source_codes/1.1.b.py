...
def main():
    ...
    q_true=-np.sort(-np.random.normal(0,0.08,6))
    bandit_LUCB = LUCBBandit(arms=6, delta=args.delta, eps=args.epsilon, total_steps=args.steps)
    bandit_UCB = UCBBandit(arms=6, delta=args.delta, eps=args.epsilon, total_steps=args.steps)
